...
Create Job
Create job in Windows Task Scheduler for script Get System Report.
(c) 2016-2020 Michal Zobec, ZOBEC Consulting. All Rights Reserved.  
...
$Scriptfile = (split-path $myinvocation.mycommand.path) + "\Device-Was-Restarted.ps1"
...
# $Principal = New-ScheduledTaskPrincipal -LogonType S4U -UserId $env:USERDOMAIN\$env:USERNAME -RunLevel Highest
$TaskName = "Device was Restarted Notification"
$Description = "Device was Restarted Notification script`ninstalled $DateTime"
